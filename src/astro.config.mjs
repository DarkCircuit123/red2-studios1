...
loadFramewire(true);`
  ...
  image: {
    domains: ["static.wixstatic.com", "wix:image", "wix:image://v1"],
  },
  server: {
    allowedHosts: true,
    host: true,
