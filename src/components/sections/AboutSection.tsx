...
export default function AboutSection() {
  return (
    <section id="about" className="relative w-full py-24 md:py-32 bg-white">
      <div className="max-w-[120rem] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-6xl md:text-7xl font-heading font-bold text-black mb-12 tracking-tighter leading-tight">
              About the Vision
            </h2>

            <div className="space-y-8 mb-12">
              <p className="text-base font-paragraph text-black/70 leading-relaxed">
            ...
            {/* Stats - ultra-minimal */}
            <div className="grid grid-cols-3 gap-12 pt-12 border-t border-black/10">
              <div>
                <p className="text-4xl font-heading font-bold text-black mb-3">
                  500+
                </p>
