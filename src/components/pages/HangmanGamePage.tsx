  ...
  const categoriesData: Record<string, CategoryMeta> = {
    'SUPER_MODELS': {
      ...
      words: [
        ...
        'KARLIE', 'TAYLOR', 'MIRANDA', 'CHRISTIE', 'IMAN', 'BEVERLY', 'TWIGGY', 'AUDREY', 'MARILYN', 'DIANA',
        'COCO', 'NAOMI', 'CAMPBELL', 'CRAWFORD', 'CRAWFORD', 'MOSS', 'BUNDCHEN', 'HADID', 'JENNER', 'HADID',
        'EVANGELISTA', 'TURLINGTON', 'SEYMOUR', 'MACPHERSON', 'BRINKLEY', 'CRAWFORD', 'FOSTER', 'SCHIFFER', 'HALL', 'BERRY',
        'HALLE', 'TYSON', 'BANKS', 'SMALLS', 'CAMPBELL', 'EVANGELISTA', 'TURLINGTON', 'MACPHERSON', 'BRINKLEY', 'FOSTER',
        'SCHIFFER', 'HALL', 'BERRY', 'HALLE', 'TYSON', 'BANKS', 'SMALLS', 'CAMPBELL', 'EVANGELISTA', 'TURLINGTON',
        'MACPHERSON', 'BRINKLEY', 'FOSTER', 'SCHIFFER', 'HALL', 'BERRY', 'HALLE', 'TYSON', 'BANKS', 'SMALLS',
        'RUNWAY', 'CATWALK', 'STRUT', 'POSE', 'SMIZE', 'FIERCE', 'PRESENCE', 'CHARISMA', 'ELEGANCE', 'GRACE',
        'POISE', 'CONFIDENCE', 'ATTITUDE', 'STYLE', 'FASHION', 'GLAMOUR', 'ICONIC', 'LEGENDARY', 'SUPERMODEL', 'CELEBRITY',
        'STAR', 'ICON', 'LEGEND', 'MUSE', 'INSPIRATION', 'TRENDSETTER', 'FASHIONISTA', 'DIVA', 'QUEEN', 'PRINCESS',
        'BEAUTY', 'GORGEOUS', 'STUNNING', 'RADIANT', 'LUMINOUS', 'STRIKING', 'CAPTIVATING', 'MESMERIZING', 'ENCHANTING', 'ALLURING',
        'PORTFOLIO', 'HEADSHOT', 'COMPOSITE', 'TEARSHEET', 'EDITORIAL', 'COMMERCIAL', 'PRINT', 'DIGITAL', 'VIDEO', 'CAMPAIGN',
        'BOOKING', 'CONTRACT', 'RATE', 'PAYMENT', 'AGENCY', 'AGENT', 'BOOKER', 'SCOUT', 'TALENT', 'MANAGER',
        'COACH', 'TRAINER', 'DIRECTOR', 'PHOTOGRAPHER', 'STYLIST', 'MAKEUP', 'HAIR', 'WARDROBE', 'DESIGNER', 'BRAND',
        'AMBASSADOR', 'ENDORSEMENT', 'SPONSORSHIP', 'COLLABORATION', 'PARTNERSHIP', 'INFLUENCER', 'SOCIAL', 'MEDIA', 'FOLLOWERS', 'ENGAGEMENT',
        'FASHION', 'WEEK', 'SHOW', 'COLLECTION', 'SEASON', 'TREND', 'AESTHETIC', 'VIBE', 'ENERGY', 'MOVEMENT',
        'WALK', 'STRIDE', 'PACE', 'TEMPO', 'RHYTHM', 'BEAT', 'MUSIC', 'SONG', 'TRACK', 'PERFORMANCE',
        'PRESENCE', 'BEARING', 'DEPORTMENT', 'CARRIAGE', 'GAIT', 'POSTURE', 'STANCE', 'EXPRESSION', 'GAZE', 'LOOK',
        'PROFILE', 'ANGLE', 'CHEEKBONE', 'JAWLINE', 'BONE', 'STRUCTURE', 'SYMMETRY', 'PROPORTION', 'HEIGHT', 'WEIGHT',
        'MEASUREMENTS', 'BUST', 'WAIST', 'HIP', 'INSEAM', 'SHOE', 'SIZE', 'HAIR', 'COLOR', 'TEXTURE'
      ]
    },
    'CAMERAS': {
      name: 'CAMERAS',
    ...
    'HOLLYWOOD_STARS': {
      ...
      words: [
        'AUDREY', 'MARILYN', 'DIANA', 'COCO', 'TWIGGY', 'TAYLOR', 'RIHANNA', 'BEYONCE', 'MADONNA', 'BRITNEY',
        'CHRISTINA', 'SHAKIRA', 'JENNIFER', 'ANGELINA', 'SCARLETT', 'BLAKE', 'JESSICA', 'MIRANDA', 'OLIVIA', 'EMMA',
        'NATALIE', 'CHARLIZE', 'MERYL', 'JULIA', 'SANDRA', 'REESE', 'CAMERON', 'RACHEL', 'MONICA', 'PHOEBE',
        'ROSS', 'CHANDLER', 'JOEY', 'GUNTHER', 'JANICE', 'ERICA', 'FRANK', 'ALICE', 'SUSAN', 'CAROL',
        'BEN', 'JACK', 'DAVID', 'VICTORIA', 'BROOKLYN', 'ROMEO', 'CRUZ', 'HARPER', 'PRINCE', 'PRINCESS',
        'KING', 'QUEEN', 'DUKE', 'DUCHESS', 'EARL', 'COUNTESS', 'BARON', 'BARONESS', 'MARQUIS', 'MARQUESS',
        'VISCOUNT', 'VISCOUNTESS', 'KNIGHT', 'DAME', 'LORD', 'LADY', 'SIR', 'MADAM', 'EMPEROR', 'EMPRESS',
        'SULTAN', 'SULTANA', 'PHARAOH', 'CLEOPATRA', 'NEFERTITI', 'HATSHEPSUT', 'RAMESSES', 'TUTANKHAMUN', 'CAESAR', 'POMPEY',
        'BRUTUS', 'ANTONY', 'OCTAVIAN', 'NERO', 'CALIGULA', 'CLAUDIUS', 'TITUS', 'DOMITIAN', 'TRAJAN', 'HADRIAN',
        'ANTONINUS', 'MARCUS', 'AURELIUS', 'COMMODUS', 'SEPTIMIUS', 'SEVERUS', 'CARACALLA', 'ELAGABALUS', 'ALEXANDER', 'PHILIP',
        'ARISTOTLE', 'SOCRATES', 'PLATO', 'HOMER', 'VIRGIL', 'DANTE', 'SHAKESPEARE', 'CERVANTES', 'MOLIERE', 'GOETHE',
        'SCHILLER', 'BYRON', 'SHELLEY', 'KEATS', 'WORDSWORTH', 'COLERIDGE', 'BLAKE', 'BURNS', 'AUSTEN', 'BRONTE',
        'DICKENS', 'THACKERAY', 'ELIOT', 'HARDY', 'JAMES', 'LAWRENCE', 'JOYCE', 'WOOLF', 'FITZGERALD', 'HEMINGWAY',
        'FAULKNER', 'STEINBECK', 'SALINGER', 'KEROUAC', 'GINSBERG', 'MORRISON', 'WALKER', 'ANGELOU', 'BALDWIN', 'HUGHES',
        'HURSTON', 'ELLISON', 'WRIGHT', 'GIOVANNI', 'SANCHEZ', 'REED', 'BARAKA', 'AMIRI', 'NIKKI', 'SONIA',
        'AUDRE', 'JUNE', 'ALICE', 'TONI', 'GLORIA', 'BELL', 'HOOKS', 'SIMONE', 'NINA', 'ARETHA',
        'ELLA', 'BILLIE', 'BESSIE', 'ETHEL', 'JOSEPHINE', 'LENA', 'DOROTHY', 'PEARL', 'RUBY', 'SAPPHIRE',
        'EMERALD', 'DIAMOND', 'CRYSTAL', 'AMBER', 'JADE', 'OPAL', 'IRIS', 'LEGEND', 'HERO', 'HEROINE',
        'TITAN', 'GIANT', 'VISIONARY', 'PIONEER', 'TRAILBLAZER', 'REVOLUTIONARY', 'INNOVATOR', 'GENIUS', 'MASTER', 'ACTOR',
        'ACTRESS', 'STAR', 'CELEBRITY', 'ICON', 'IDOL', 'SUPERSTAR', 'MEGASTAR', 'BLOCKBUSTER', 'OSCAR', 'AWARD'
      ]
    },
    'MODELING_AGENCIES': {
