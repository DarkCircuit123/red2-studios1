...
export default function HangmanGamePage() {
  ...
  const categoriesData: Record<string, CategoryMeta> = {
    ...
    'CAMERAS': {
      ...
      icon: '📸',
      justification: 'Master the art of photography. Every word is a name of a camera brand, model, or photography equipment manufacturer that defined the industry.',
      words: [
        'CANON', 'NIKON', 'SONY', 'PENTAX', 'FUJIFILM', 'OLYMPUS', 'PANASONIC', 'LEICA', 'HASSELBLAD', 'MAMIYA',
        'CONTAX', 'ROLLEI', 'BRONICA', 'GRAFLEX', 'HORSEMAN', 'SINAR', 'TOYO', 'CAMBO', 'ARCA', 'LINHOF',
        'EBONY', 'WISNER', 'CHAMONIX', 'TACHIHARA', 'WISTA', 'INTREPID', 'TMAX', 'PORTRA', 'KODAK', 'FUJI',
        'ILFORD', 'AGFA', 'FOMAPAN', 'ORWO', 'FERRANIA', 'LOMOGRAPHY', 'IMPOSSIBLE', 'POLAROID', 'INSTAX', 'HOLGA',
        'DIANA', 'FISHEYE', 'LOMO', 'SPROCKET', 'PINHOLE', 'STEREO', 'PANORAMIC', 'MEDIUM', 'LARGE', 'FORMAT'
      ]
    },
    'HOLLYWOOD_STARS': {
      ...
      words: [
        'TOMHANKS', 'MERYLSTREEP', 'DENZELWASHINGTON', 'KATEWINSLET', 'LEONARDODICAPRIO', 'OPRAHWINFREY', 'TOMCRUISE', 'ANGELINAJOLIE', 'BRADPITT', 'JOHNNYDEPP',
        'JACKNICHOLSON', 'CLINTEASTWOOD', 'STEVESPIELBERG', 'MARTINSCORSESE', 'CHRISTOPHERNOLAN', 'QUENTINTARANTINO', 'JAMESBLACK', 'CAMERON', 'RIDLEYSCOTT', 'SPIELBERG',
        ...
        'ROBERTPATTINSON', 'CHRISEVANS', 'CHRISHEMSWORTH', 'TOMHIDDLESTON', 'BENEDICTCUMBERBATCH', 'AIDANTURNER', 'ORLANDOBLOOM', 'VIGGOMRTENSEN', 'ELIJAHWOOD', 'IANDMCKELLEN'
      ]
    },
    'MODELING_AGENCIES': {
      ...
      icon: '🏢',
      justification: 'Explore the world of modeling agencies and fashion industry. Every word is a name of a major modeling agency or talent management company that represents top models.',
      words: [
        'ELITE', 'FORD', 'NEXT', 'WILHELMINA', 'WOMEN', 'MANAGEMENT', 'CLICK', 'MAJOR', 'VISION', 'SUPREME',
        'PREMIER', 'AGENCY', 'MODELS', 'INTERNATIONAL', 'TALENT', 'STARS', 'ICONIC', 'PRESTIGE', 'LUXURY', 'FASHION',
        'RUNWAY', 'CATWALK', 'BOOKING', 'REPRESENTATION', 'PORTFOLIO', 'HEADSHOT', 'COMPOSITE', 'TEARSHEET', 'EDITORIAL', 'COMMERCIAL',
        'PRINT', 'DIGITAL', 'VIDEO', 'SHOWROOM', 'FITTING', 'ALTERATION', 'TAILORING', 'SEAMSTRESS', 'DESIGNER', 'STYLIST',
        'WARDROBE', 'MAKEUP', 'HAIR', 'SKINCARE', 'BEAUTY', 'WELLNESS', 'FITNESS', 'NUTRITION', 'DIET', 'EXERCISE'
      ]
    },
    'CLOTHING_DESIGNERS': {
      ...
      words: [
        'CHANEL', 'VALENTINO', 'VERSACE', 'ARMANI', 'GUCCI', 'PRADA', 'DIOR', 'HERMES', 'LOUISVUITTON', 'BURBERRY',
        'BALENCIAGA', 'GIVENCHY', 'YVES', 'SAINTLAURENT', 'RALPHLAUREN', 'TOMMYHILFIGER', 'CALVINKLEIN', 'MARCJACOBS', 'DONNAKARANM', 'ISSEYMIYAKE',
        'JEANPAULGAULTIER', 'ALEXANDERMCQUEEN', 'STELLAMCCARTNEY', 'VIVIENNEWESTWOOD', 'KATHARINE', 'HAMNETT', 'JILSANDER', 'HELMUTLANG', 'RICARDOTISCI', 'TOMFORD',
        'CHRISTOPHERBAILEY', 'KARLLARGERFELD', 'MARCELCELINE', 'NICOLASGHESQUIERE', 'ALBER', 'ELBAZ', 'RAFSIMONS', 'PETERHALLEY', 'THIERRYMUGLER', 'HUSSEINCHALAYANM',
        'JOHNROCHA', 'FENDI', 'BOTTEGA', 'VENETA', 'MIUMIU', 'LOEWE', 'LANVIN', 'BALMAIN', 'ELIE', 'SAAB'
      ]
    },
    'MAKEUP_COMPANIES': {
