...
export default function PortfolioPage() {
  const { items: projects, loading: isLoading } = useCMSCollection<Portfolio>('portfolio', { limit: 50 });
  ...
  return (
    <ErrorBoundary>
      <SEOHead
        title="Portfolio | RED2 STUDIOS"
        description="A comprehensive collection of photography work across various categories and styles. Each project represents precision and creative excellence."
        type="website"
      />
